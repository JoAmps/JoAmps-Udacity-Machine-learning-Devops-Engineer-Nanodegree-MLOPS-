...
def process_data(
    ...
    Processes the data using one hot \
        encoding for the categorical \
            features and a
    label binarizer for the labels. This \
        can be used in either training or
    ...
    encoder : sklearn.preprocessing._encoders.OneHotEncoder
        Trained sklearn OneHotEncoder, only\
             used if training=False.
    lb : sklearn.preprocessing._label.LabelBinarizer
        Trained sklearn LabelBinarizer, only\
             used if training=False.
